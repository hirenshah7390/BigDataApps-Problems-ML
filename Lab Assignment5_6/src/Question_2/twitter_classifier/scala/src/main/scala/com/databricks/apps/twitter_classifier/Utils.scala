...
object Utils {
  ...
  val CONSUMER_KEY = "YDvMtLCSLnslXX3m4pY4z2aDb"
  val CONSUMER_SECRET = "cOi1FkNVgibru1rp1Rtcy3sdUjzujc5JAGowxk0YkFmbq0Otmu"
  val ACCESS_TOKEN = "3534109580-EnBKBt17Y2XEuaZc8cmUXPLNRgIfZN1vM0NBB6w"
  val ACCESS_TOKEN_SECRET = "UavesZwDDMEDmkWgutZXGvBDynE4qB4QxktiuHbIKtw0W"
